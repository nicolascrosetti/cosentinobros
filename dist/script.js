...
const navbarSmall = () => {
  ...
  navlogo.classList.remove("h-[100px]");

  navbarText.classList.add("text-sm");
  navbarText.classList.remove("text-xl");
}

const navbarNormal = () => {
  navlogo.classList.add("h-[100px]");
  navlogo.classList.remove("h-[50px]");

  navbarText.classList.remove("text-sm");
  navbarText.classList.add("text-xl");
}
